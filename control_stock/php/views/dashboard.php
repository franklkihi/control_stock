...
<head>
  ...
  <title>Dashboard — Protecciones.rx</title>
...
<div class="main-content">
  ...
  <div class="card">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:18px">
      <span class="card-title" style="margin:0">📦 Últimos productos</span>
      <a href="index.php?action=crearProducto" class="btn btn-primary btn-sm">+ Nuevo producto</a>
    </div>
    ...
    <div class="table-wrap">
      <table>
        <thead>
          <tr>
            <th>Ref.</th><th>Producto</th><th>SKU</th><th>Cantidad</th><th>Precio</th><th>Acciones</th>
          </tr>
        </thead>
        <tbody>
          <?php if (empty($productos)): ?>
            <tr><td colspan="6">
              <div class="empty-state">
                ...
                No hay productos aún. <a href="index.php?action=crearProducto">Agrega el primero</a>
              </div>
            </td></tr>
          <?php else: ?>
    ...
    <?php if (count($productos) > 5): ?>
      <div style="text-align:center;margin-top:16px">
        <a href="index.php?action=productos" class="btn btn-outline btn-sm">Ver todos los productos →</a>
      </div>
    <?php endif; ?>
  </div>
